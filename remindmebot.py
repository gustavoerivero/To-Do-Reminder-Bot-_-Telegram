...
## Bot
bot = telebot.TeleBot("1624241159:AAGu2u6nBEiAr1xoNaS9bqxygLB7hQSLLUI")
dic_user = {}

## Setup Database
client = pymongo.MongoClient("mongodb://admin:<1234>@mdb-shard-00-00.z34ey.mongodb.net:27017,mdb-shard-00-01.z34ey.mongodb.net:27017,mdb-shard-00-02.z34ey.mongodb.net:27017/<Telegram_RemindMeToDoBot>?ssl=true&replicaSet=atlas-c7xfze-shard-0&authSource=admin&retryWrites=true&w=majority")
db_name = "Telegram_RemindMeToDoBot"
...
def _help(message):
    msg =   "Set an event, like Business meeting, for example: \n\
            Business Meeting: Oct 25 \nAnd I'm gonna save the date and the Oct 25 I will remind you of the Business Meeting. \n\
            Save a date with \n/save \n\
...
def _save(message):
    msg =   "Set an event in the format 'month dd', for example: \n\
            Weekly Business Meeting: Jan 15 \n\
            I also understand: \n\
...
def _start(message):
    ...
    ## First Message
    msg = "Hi there " + str(message.chat.username) + \
          ", I'm a To-Do reminder. Tell me tasks and events to remind you. To learn how to use me, use \n/help"
    bot.send_message(message.chat.id, msg)
